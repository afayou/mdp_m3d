...
class Trainer:
    def __init__(self, options):
        ...
        datasets_dict = {"kitti": datasets.KITTIRAWDataset,
                         ...
                         'kitti_object': datasets.KITTIObjectDataset}
        ...
        # show configuration
        pretty = pretty_print('conf', self.conf)
        logging.info(pretty)
        # -----------------------------------------
        # network and loss
        # -----------------------------------------
        ...
        # training network
        self.rpn_net, self.optimizer = init_training_model(self.conf, self.paths.output)
    ...
    def run_epoch(self):
        ...
        for batch_idx, inputs in enumerate(self.train_loader):
            ...
            if early_phase or late_phase:
                self.log_time(batch_idx, duration, losses["loss"].cpu().data, self.m3d_loss)
    ...
    def process_batch(self, inputs, m3d_loss):
        ...
        losses = self.compute_losses(inputs, outputs, m3d_loss)
    ...
    def compute_losses(self, inputs, outputs, m3d_loss):
        ...
        losses["loss"] = total_loss + m3d_loss * 0.1
        return losses
    ...
    def log_time(self, batch_idx, duration, loss, m3d_loss):
        ...
        print_string = "epoch {:>3} | batch {:>6} | examples/s: {:5.1f}" + \
            " | loss: {:.5f} | m3d_loss: {:.5f} |time elapsed: {} | time left: {}"
        print(print_string.format(self.epoch, batch_idx, samples_per_sec, loss, m3d_loss,
