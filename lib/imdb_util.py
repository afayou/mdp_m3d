...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, batch_size, conf, root, cache_folder=None):
        """
        ...
        self.loader = torch.utils.data.DataLoader(self, self.batch_size, sampler=self.sampler, collate_fn=self.collate)
